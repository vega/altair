...
html_theme_options = {
    ...
    "announcement": """This website is for the release candidate of version 5 <code class="docutils literal notranslate"><span class="pre">pip install altair==5.0.0rc1</span></code> (more info <a href='https://github.com/altair-viz/altair/issues/2937'>#2937</a>). You can find the documentation for version 4 <a href='https://altair-viz.github.io/altair-viz-v4/'>here</a>.""",
}
