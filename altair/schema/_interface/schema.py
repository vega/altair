...
class CompositeMarkConfigMixins(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'boxMid': jst.JSONInstance(_localname('MarkConfig')), '_required_traits': [], 'box': jst.JSONInstance(_localname('BoxPlotConfig'), help='Box Config'), 'boxWhisker': jst.JSONInstance(_localname('MarkConfig')), '_additional_traits': False})),)


class CompositeMarkDef(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'type': BOXPLOT(), '_additional_traits': False, 'extent': jst.JSONAnyOf([jst.JSONEnum(['min-max']), jst.JSONNumber()]), '_required_traits': ['type'], 'orient': Orient()})),)


class CompositeUnitSpec(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'data': jst.JSONInstance(_localname('Data'), help='An object describing the data source'), 'description': jst.JSONString(help='An optional description of this mark for commenting purpose.'), 'transform': jst.JSONArray(jst.JSONInstance(_localname('Transform')), help='An array of data transformations such as filter and new field [...]'), 'width': jst.JSONNumber(help='The width of a visualization. __Default value:__ This will be [...]'), 'name': jst.JSONString(help='Name of the visualization for later reference.'), 'selection': jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': [jst.JSONInstance(_localname('SelectionDef'))], '_required_traits': []}), help='A key-value mapping between selection names and definitions.'), '_additional_traits': False, 'mark': jst.JSONAnyOf([jst.JSONAnyOf([BOXPLOT(), ERRORBAR()]), jst.JSONInstance(_localname('CompositeMarkDef')), Mark(help='All types of primitive marks.'), jst.JSONInstance(_localname('MarkDef'))]), 'encoding': jst.JSONInstance(_localname('Encoding'), help='A key-value mapping between encoding channels and definition of [...]'), '_required_traits': ['mark', 'encoding'], 'height': jst.JSONNumber(help='The height of a visualization. __Default value:__ - For y-axis [...]')})),)


class FacetedUnitSpec(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'data': jst.JSONInstance(_localname('Data'), help='An object describing the data source'), 'description': jst.JSONString(help='An optional description of this mark for commenting purpose.'), 'transform': jst.JSONArray(jst.JSONInstance(_localname('Transform')), help='An array of data transformations such as filter and new field [...]'), 'width': jst.JSONNumber(help='The width of a visualization. __Default value:__ This will be [...]'), 'name': jst.JSONString(help='Name of the visualization for later reference.'), 'selection': jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': [jst.JSONInstance(_localname('SelectionDef'))], '_required_traits': []}), help='A key-value mapping between selection names and definitions.'), '_additional_traits': False, 'mark': jst.JSONAnyOf([jst.JSONAnyOf([BOXPLOT(), ERRORBAR()]), jst.JSONInstance(_localname('CompositeMarkDef')), Mark(help='All types of primitive marks.'), jst.JSONInstance(_localname('MarkDef'))]), 'encoding': jst.JSONInstance(_localname('EncodingWithFacet'), help='A key-value mapping between encoding channels and definition of [...]'), '_required_traits': ['mark', 'encoding'], 'height': jst.JSONNumber(help='The height of a visualization. __Default value:__ - For y-axis [...]')})),)
...
class SelectionDomain(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': False, '_required_traits': ['selection'], 'selection': jst.JSONString(), 'field': jst.JSONString()})),jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'encoding': jst.JSONString(), '_required_traits': ['selection'], 'selection': jst.JSONString(), '_additional_traits': False})),)
...
class Config(jst.JSONHasTraits):
    ...
    padding = jst.JSONAnyOf([jst.JSONNumber(), jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'left': jst.JSONNumber(), '_required_traits': [], 'bottom': jst.JSONNumber(), 'top': jst.JSONNumber(), '_additional_traits': False, 'right': jst.JSONNumber()}))])
