...
class CompositeMarkConfigMixins(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'boxMid': jst.JSONInstance(_localname('MarkConfig')), 'box': jst.JSONInstance(_localname('BoxPlotConfig'), help='Box Config'), '_required_traits': [], 'boxWhisker': jst.JSONInstance(_localname('MarkConfig')), '_additional_traits': False})),)


class CompositeMarkDef(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'orient': Orient(), 'type': BOXPLOT(), 'extent': jst.JSONAnyOf([jst.JSONEnum(['min-max']), jst.JSONNumber()]), '_additional_traits': False, '_required_traits': ['type']})),)


class CompositeUnitSpec(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': ['mark', 'encoding'], 'encoding': jst.JSONInstance(_localname('Encoding'), help='A key-value mapping between encoding channels and definition of [...]'), 'transform': jst.JSONArray(jst.JSONInstance(_localname('Transform')), help='An array of data transformations such as filter and new field [...]'), 'mark': jst.JSONAnyOf([jst.JSONAnyOf([BOXPLOT(), ERRORBAR()]), jst.JSONInstance(_localname('CompositeMarkDef')), Mark(help='All types of primitive marks.'), jst.JSONInstance(_localname('MarkDef'))]), 'description': jst.JSONString(help='An optional description of this mark for commenting purpose.'), '_additional_traits': False, 'width': jst.JSONNumber(help='The width of a visualization. __Default value:__ This will be [...]'), 'height': jst.JSONNumber(help='The height of a visualization. __Default value:__ - For y-axis [...]'), 'selection': jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': [], '_additional_traits': [jst.JSONInstance(_localname('SelectionDef'))]}), help='A key-value mapping between selection names and definitions.'), 'name': jst.JSONString(help='Name of the visualization for later reference.'), 'data': jst.JSONInstance(_localname('Data'), help='An object describing the data source')})),)


class FacetedUnitSpec(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': ['mark', 'encoding'], 'encoding': jst.JSONInstance(_localname('EncodingWithFacet'), help='A key-value mapping between encoding channels and definition of [...]'), 'transform': jst.JSONArray(jst.JSONInstance(_localname('Transform')), help='An array of data transformations such as filter and new field [...]'), 'mark': jst.JSONAnyOf([jst.JSONAnyOf([BOXPLOT(), ERRORBAR()]), jst.JSONInstance(_localname('CompositeMarkDef')), Mark(help='All types of primitive marks.'), jst.JSONInstance(_localname('MarkDef'))]), 'description': jst.JSONString(help='An optional description of this mark for commenting purpose.'), '_additional_traits': False, 'width': jst.JSONNumber(help='The width of a visualization. __Default value:__ This will be [...]'), 'height': jst.JSONNumber(help='The height of a visualization. __Default value:__ - For y-axis [...]'), 'selection': jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': [], '_additional_traits': [jst.JSONInstance(_localname('SelectionDef'))]}), help='A key-value mapping between selection names and definitions.'), 'name': jst.JSONString(help='Name of the visualization for later reference.'), 'data': jst.JSONInstance(_localname('Data'), help='An object describing the data source')})),)
...
class SelectionDomain(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': ['selection'], 'field': jst.JSONString(), 'selection': jst.JSONString(), '_additional_traits': False})),jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': ['selection'], 'selection': jst.JSONString(), 'encoding': jst.JSONString(), '_additional_traits': False})),)
...
class BaseSelectionDef(jst.JSONHasTraits):
    ...
    on = jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': [], '_additional_traits': True}), help='A Vega event stream (object or selector) that triggers the selection.')
...
class CompositeUnitSpecAlias(jst.JSONHasTraits):
    ...
    name = jst.JSONString(help='Name of the visualization for later reference.')
    selection = jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': [], '_additional_traits': [jst.JSONInstance(_localname('SelectionDef'))]}), help='A key-value mapping between selection names and definitions.')
    transform = jst.JSONArray(jst.JSONInstance(_localname('Transform')), help='An array of data transformations such as filter and new field [...]')
...
class Config(jst.JSONHasTraits):
    ...
    padding = jst.JSONAnyOf([jst.JSONNumber(), jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'bottom': jst.JSONNumber(), '_required_traits': [], 'top': jst.JSONNumber(), 'left': jst.JSONNumber(), '_additional_traits': False, 'right': jst.JSONNumber()}))])
    point = jst.JSONInstance(_localname('MarkConfig'), help='Point-Specific Config')
    range = jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': [], '_additional_traits': [jst.JSONAnyOf([jst.JSONArray(jst.JSONUnion([jst.JSONNumber(), jst.JSONString()])), jst.JSONInstance(_localname('VgRangeScheme')), jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'step': jst.JSONNumber(), '_required_traits': ['step'], '_additional_traits': False}))])]}), help='Scale range config, or properties defining named range arrays [...]')
...
class DataFormat(jst.JSONHasTraits):
    ...
    parse = jst.JSONAnyOf([jst.JSONEnum(['auto']), jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': [], '_additional_traits': True}))], help='If set to auto (the default), perform automatic type inference [...]')
...
class SingleSelection(jst.JSONHasTraits):
    ...
    _additional_traits = False
    _required_traits = ['type']
    bind = jst.JSONAnyOf([jst.JSONInstance(_localname('VgBinding')), jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': [], '_additional_traits': [jst.JSONInstance(_localname('VgBinding'))]}))], help='Establish a two-way binding between a single selection and input [...]')
    encodings = jst.JSONArray(SingleDefChannel(), help='An array of encoding channels. The corresponding data field [...]')
    fields = jst.JSONArray(jst.JSONString(), help='An array of field names whose values must match for a data tuple [...]')
    nearest = jst.JSONBoolean(help='When true, an invisible voronoi diagram is computed to [...]')
    on = jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': [], '_additional_traits': True}), help='A Vega event stream (object or selector) that triggers the selection.')
...
class ValueDef(jst.JSONHasTraits):
    ...
    _additional_traits = False
    _required_traits = ['value']
    value = jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': [], '_additional_traits': True}), help='A constant value in visual domain.')
