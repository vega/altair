...
class Transform(BaseObject):
    ...
    """
    calculate = T.List(T.Instance(Formula, allow_none=True, default_value=None), allow_none=True, default_value=None, help="""Calculate new field(s) using the provided expresssion(s).""")
