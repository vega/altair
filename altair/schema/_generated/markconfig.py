...
class MarkConfig(BaseObject):
    ...
    fillOpacity = T.CFloat(allow_none=True, min=0, default_value=None, max=1)
    ...
    opacity = T.CFloat(allow_none=True, min=0, default_value=None, max=1)
    ...
    strokeOpacity = T.CFloat(allow_none=True, min=0, default_value=None, max=1)
    strokeWidth = T.CFloat(allow_none=True, min=0, default_value=None)
