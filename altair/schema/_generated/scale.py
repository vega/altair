...
class Scale(BaseObject):
    ...
    domain = T.Union([T.List(T.CFloat(allow_none=True, default_value=None), allow_none=True, default_value=None), T.List(T.Unicode(allow_none=True, default_value=None), allow_none=True, default_value=None), T.Unicode(allow_none=True, default_value=None)])
    ...
    nice = T.Union([NiceTime(allow_none=True, default_value=None), T.Bool(allow_none=True, default_value=None)])
    padding = T.CFloat(allow_none=True, default_value=None, help="""Applies spacing among ordinal elements in the scale range.""")
    range = T.Union([T.List(T.CFloat(allow_none=True, default_value=None), allow_none=True, default_value=None), T.List(T.Unicode(allow_none=True, default_value=None), allow_none=True, default_value=None), T.Unicode(allow_none=True, default_value=None)])
