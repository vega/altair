...
class CompositeMarkConfigMixins(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': False, '_required_traits': [], 'box': jst.JSONInstance(_localname('BoxPlotConfig'), help='Box Config'), 'boxMid': jst.JSONInstance(_localname('MarkConfig')), 'boxWhisker': jst.JSONInstance(_localname('MarkConfig'))})),)


class CompositeMarkDef(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': False, '_required_traits': ['type'], 'extent': jst.JSONAnyOf([jst.JSONEnum(['min-max']), jst.JSONNumber()]), 'orient': Orient(), 'type': BOXPLOT()})),)


class CompositeUnitSpec(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': False, '_required_traits': ['mark', 'encoding'], 'data': jst.JSONInstance(_localname('Data'), help='An object describing the data source'), 'description': jst.JSONString(help='An optional description of this mark for commenting purpose.'), 'encoding': jst.JSONInstance(_localname('Encoding'), help='A key-value mapping between encoding channels and definition of [...]'), 'height': jst.JSONNumber(help='The height of a visualization. __Default value:__ - For y-axis [...]'), 'mark': jst.JSONAnyOf([jst.JSONAnyOf([BOXPLOT(), ERRORBAR()]), jst.JSONInstance(_localname('CompositeMarkDef')), Mark(help='All types of primitive marks.'), jst.JSONInstance(_localname('MarkDef'))]), 'name': jst.JSONString(help='Name of the visualization for later reference.'), 'selection': jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': [jst.JSONInstance(_localname('SelectionDef'))], '_required_traits': []}), help='A key-value mapping between selection names and definitions.'), 'transform': jst.JSONArray(jst.JSONInstance(_localname('Transform')), help='An array of data transformations such as filter and new field [...]'), 'width': jst.JSONNumber(help='The width of a visualization. __Default value:__ This will be [...]')})),)


class FacetedUnitSpec(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': False, '_required_traits': ['mark', 'encoding'], 'data': jst.JSONInstance(_localname('Data'), help='An object describing the data source'), 'description': jst.JSONString(help='An optional description of this mark for commenting purpose.'), 'encoding': jst.JSONInstance(_localname('EncodingWithFacet'), help='A key-value mapping between encoding channels and definition of [...]'), 'height': jst.JSONNumber(help='The height of a visualization. __Default value:__ - For y-axis [...]'), 'mark': jst.JSONAnyOf([jst.JSONAnyOf([BOXPLOT(), ERRORBAR()]), jst.JSONInstance(_localname('CompositeMarkDef')), Mark(help='All types of primitive marks.'), jst.JSONInstance(_localname('MarkDef'))]), 'name': jst.JSONString(help='Name of the visualization for later reference.'), 'selection': jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': [jst.JSONInstance(_localname('SelectionDef'))], '_required_traits': []}), help='A key-value mapping between selection names and definitions.'), 'transform': jst.JSONArray(jst.JSONInstance(_localname('Transform')), help='An array of data transformations such as filter and new field [...]'), 'width': jst.JSONNumber(help='The width of a visualization. __Default value:__ This will be [...]')})),)
...
class SelectionDomain(jst.AnyOfObject):
    _classes = (jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': False, '_required_traits': ['selection'], 'field': jst.JSONString(), 'selection': jst.JSONString()})),jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': False, '_required_traits': ['selection'], 'encoding': jst.JSONString(), 'selection': jst.JSONString()})),)
...
class Config(jst.JSONHasTraits):
    ...
    range = jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': [jst.JSONAnyOf([jst.JSONArray(jst.JSONUnion([jst.JSONNumber(), jst.JSONString()])), jst.JSONInstance(_localname('VgRangeScheme')), jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_additional_traits': False, '_required_traits': ['step'], 'step': jst.JSONNumber()}))])], '_required_traits': []}), help='Scale range config, or properties defining named range arrays [...]')
