...
class Axis(jst.JSONHasTraits):
    ...
    orient = AxisOrient()
    properties = jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': [], '_additional_traits': True}), help='Optional mark property definitions for custom axis styling.')
...
class DataFormat(jst.JSONHasTraits):
    ...
    parse = jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': [], '_additional_traits': True}), help='A collection of parsing instructions can be used to define the [...]')
...
class Legend(jst.JSONHasTraits):
    ...
    properties = jst.JSONInstance(T.MetaHasTraits('Mapping', (jst.JSONHasTraits,), {'_required_traits': [], '_additional_traits': True}), help='Optional mark property definitions for custom legend styling.')
