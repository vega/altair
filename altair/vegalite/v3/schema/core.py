...
class BoxPlotDef(VegaLiteSchema):
    ...
    def __init__(self, type=Undefined, box=Undefined, color=Undefined, extent=Undefined,
                 median=Undefined, opacity=Undefined, orient=Undefined, outliers=Undefined,
                 rule=Undefined, size=Undefined, ticks=Undefined, **kwds):
        super(BoxPlotDef, self).__init__(type=type, box=box, color=color, extent=extent, median=median,
                                         opacity=opacity, orient=orient, outliers=outliers, rule=rule,
                                         size=size, ticks=ticks, **kwds)
...
class ConditionalPredicateTextFieldDef(VegaLiteSchema):
    ...
    format : string
        ...
        <https://vega.gFieldDefWithoutBinnedithub.io/vega-lite/docs/format.html>`__ for a
...
class Config(VegaLiteSchema):
    ...
    def __init__(self, area=Undefined, autosize=Undefined, axis=Undefined, axisBand=Undefined,
                 ...
                 boxplot=Undefined, circle=Undefined, countTitle=Undefined, datasets=Undefined,
                 errorband=Undefined, errorbar=Undefined, fieldTitle=Undefined, geoshape=Undefined,
                 header=Undefined, invalidValues=Undefined, legend=Undefined, line=Undefined,
        ...
        super(Config, self).__init__(area=area, autosize=autosize, axis=axis, axisBand=axisBand,
                                     ...
                                     datasets=datasets, errorband=errorband, errorbar=errorbar,
...
class ErrorBandDef(VegaLiteSchema):
    ...
    def __init__(self, type=Undefined, band=Undefined, borders=Undefined, color=Undefined,
                 extent=Undefined, interpolate=Undefined, opacity=Undefined, orient=Undefined,
                 tension=Undefined, **kwds):
        super(ErrorBandDef, self).__init__(type=type, band=band, borders=borders, color=color,
                                           extent=extent, interpolate=interpolate, opacity=opacity,
                                           orient=orient, tension=tension, **kwds)
...
class ErrorBarDef(VegaLiteSchema):
    ...
    def __init__(self, type=Undefined, color=Undefined, extent=Undefined, opacity=Undefined,
                 orient=Undefined, rule=Undefined, ticks=Undefined, **kwds):
        super(ErrorBarDef, self).__init__(type=type, color=color, extent=extent, opacity=opacity,
                                          orient=orient, rule=rule, ticks=ticks, **kwds)
