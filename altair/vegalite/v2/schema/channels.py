    ...
    A FieldDef with Condition<ValueDef>
{
   ...
   ...
    ...
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, condition=Undefined, legend=Undefined, scale=Undefined, sort=Undefined, timeUnit=Undefined, **kwds):
        super(Color, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, condition=condition, legend=legend, scale=scale, sort=sort, timeUnit=timeUnit, **kwds)
...
class Column(core.FacetFieldDef):
    ...
    type : Type
        The encoded field's type of measurement (`"quantitative"`, `"temporal"`, `"ordinal"`, or `"nominal"`). It can also be a geo type (`"latitude"`, `"longitude"`, and `"geojson"`) when a [geographic projection](https://vega.github.io/vega-lite/docs/projection.html) is applied.
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, header=Undefined, sort=Undefined, timeUnit=Undefined, **kwds):
        super(Column, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, header=header, sort=sort, timeUnit=timeUnit, **kwds)
...
class Detail(core.FieldDef):
    ...
    type : Type
        The encoded field's type of measurement (`"quantitative"`, `"temporal"`, `"ordinal"`, or `"nominal"`). It can also be a geo type (`"latitude"`, `"longitude"`, and `"geojson"`) when a [geographic projection](https://vega.github.io/vega-lite/docs/projection.html) is applied.
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, timeUnit=Undefined, **kwds):
        super(Detail, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, timeUnit=timeUnit, **kwds)
    ...
    A FieldDef with Condition<ValueDef>
{
   ...
   ...
    ...
    type : Type
        The encoded field's type of measurement (`"quantitative"`, `"temporal"`, `"ordinal"`, or `"nominal"`). It can also be a geo type (`"latitude"`, `"longitude"`, and `"geojson"`) when a [geographic projection](https://vega.github.io/vega-lite/docs/projection.html) is applied.
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, condition=Undefined, timeUnit=Undefined, **kwds):
        super(Href, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, condition=condition, timeUnit=timeUnit, **kwds)
    ...
    A FieldDef with Condition<ValueDef>
{
   ...
   ...
    ...
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, condition=Undefined, legend=Undefined, scale=Undefined, sort=Undefined, timeUnit=Undefined, **kwds):
        super(Opacity, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, condition=condition, legend=legend, scale=scale, sort=sort, timeUnit=timeUnit, **kwds)
...
class Order(core.OrderFieldDef):
    ...
    type : Type
        The encoded field's type of measurement (`"quantitative"`, `"temporal"`, `"ordinal"`, or `"nominal"`). It can also be a geo type (`"latitude"`, `"longitude"`, and `"geojson"`) when a [geographic projection](https://vega.github.io/vega-lite/docs/projection.html) is applied.
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, sort=Undefined, timeUnit=Undefined, **kwds):
        super(Order, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, sort=sort, timeUnit=timeUnit, **kwds)
...
class Row(core.FacetFieldDef):
    ...
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, header=Undefined, sort=Undefined, timeUnit=Undefined, **kwds):
        super(Row, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, header=header, sort=sort, timeUnit=timeUnit, **kwds)
    ...
    A FieldDef with Condition<ValueDef>
{
   ...
   ...
    ...
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, condition=Undefined, legend=Undefined, scale=Undefined, sort=Undefined, timeUnit=Undefined, **kwds):
        super(Shape, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, condition=condition, legend=legend, scale=scale, sort=sort, timeUnit=timeUnit, **kwds)
    ...
    A FieldDef with Condition<ValueDef>
{
   ...
   ...
    ...
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, condition=Undefined, legend=Undefined, scale=Undefined, sort=Undefined, timeUnit=Undefined, **kwds):
        super(Size, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, condition=condition, legend=legend, scale=scale, sort=sort, timeUnit=timeUnit, **kwds)
    ...
    A FieldDef with Condition<ValueDef>
{
   ...
   ...
    ...
    type : Type
        The encoded field's type of measurement (`"quantitative"`, `"temporal"`, `"ordinal"`, or `"nominal"`). It can also be a geo type (`"latitude"`, `"longitude"`, and `"geojson"`) when a [geographic projection](https://vega.github.io/vega-lite/docs/projection.html) is applied.
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, condition=Undefined, format=Undefined, timeUnit=Undefined, **kwds):
        super(Text, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, condition=condition, format=format, timeUnit=timeUnit, **kwds)
    ...
    A FieldDef with Condition<ValueDef>
{
   ...
   ...
    ...
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, condition=Undefined, format=Undefined, timeUnit=Undefined, **kwds):
        super(Tooltip, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, condition=condition, format=format, timeUnit=timeUnit, **kwds)
...
class X(core.PositionFieldDef):
    ...
    type : Type
        The encoded field's type of measurement (`"quantitative"`, `"temporal"`, `"ordinal"`, or `"nominal"`). It can also be a geo type (`"latitude"`, `"longitude"`, and `"geojson"`) when a [geographic projection](https://vega.github.io/vega-lite/docs/projection.html) is applied.
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, axis=Undefined, bin=Undefined, scale=Undefined, sort=Undefined, stack=Undefined, timeUnit=Undefined, **kwds):
        super(X, self).__init__(field=field, type=type, aggregate=aggregate, axis=axis, bin=bin, scale=scale, sort=sort, stack=stack, timeUnit=timeUnit, **kwds)
...
class X2(core.FieldDef):
    ...
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, timeUnit=Undefined, **kwds):
        super(X2, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, timeUnit=timeUnit, **kwds)
...
class Y(core.PositionFieldDef):
    ...
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, axis=Undefined, bin=Undefined, scale=Undefined, sort=Undefined, stack=Undefined, timeUnit=Undefined, **kwds):
        super(Y, self).__init__(field=field, type=type, aggregate=aggregate, axis=axis, bin=bin, scale=scale, sort=sort, stack=stack, timeUnit=timeUnit, **kwds)
...
class Y2(core.FieldDef):
    ...
    """
    def __init__(self, field, type=Undefined, aggregate=Undefined, bin=Undefined, timeUnit=Undefined, **kwds):
        super(Y2, self).__init__(field=field, type=type, aggregate=aggregate, bin=bin, timeUnit=timeUnit, **kwds)
