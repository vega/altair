...
boroughs = alt.topo_feature(alt.datasets.londonBoroughs.url, 'boroughs')
tubelines = alt.topo_feature(alt.datasets.londonTubeLines.url, 'line')
centroids = alt.datasets.londonCentroids.url
