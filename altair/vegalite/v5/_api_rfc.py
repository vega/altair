...
class field2(metaclass=_FieldMeta):
...
class _ChannelDatumNamespace:
    ...
    def theta(self, *args: Any, **kwds: Any) -> Any: ...
    def theta_2(self, *args: Any, **kwds: Any) -> Any: ...
    def x(self, *args: Any, **kwds: Any) -> channels.XDatum: ...
    def x_2(self, *args: Any, **kwds: Any) -> channels.X2Datum: ...
    def x_offset(self, *args: Any, **kwds: Any) -> channels.XOffsetDatum: ...
    def y(self, *args: Any, **kwds: Any) -> channels.YDatum: ...
    def y_2(self, *args: Any, **kwds: Any) -> channels.Y2Datum: ...
    def y_offset(self, *args: Any, **kwds: Any) -> channels.YOffsetDatum: ...


abcd = field2.q1()
efg = field2.angle()
# some_field = field2.min("Cost", "Q")
some_field = field2("Cost:Q")
beeeee = some_field.x()
cee = some_field.value.x()
deee = some_field.datum.x()


ffff = field2("Cost:Q").x_2().bandPosition(4.7)
