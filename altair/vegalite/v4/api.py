...
_repeat_chart_patched_schema = {
    ...
    "properties": {
        ...
        "center": {
            "anyOf": [{"type": "boolean"}, {"$ref": "#/definitions/RowCol<boolean>"}],
        ...
        "data": {
            "anyOf": [{"$ref": "#/definitions/Data"}, {"type": "null"}],
        ...
        "spacing": {
            "anyOf": [{"type": "number"}, {"$ref": "#/definitions/RowCol<number>"}],
