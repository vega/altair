...
_repeat_chart_patched_schema = {'additionalProperties': False,
        'properties': {'$schema': {'description': 'URL to [JSON schema](http://json-schema.org/) for a Vega-Lite specification. Unless you have a reason to change this, use `https://vega.github.io/schema/vega-lite/v4.json`. Setting the `$schema` property allows automatic validation and autocomplete in editors that support JSON schema.',
        'format': 'uri',
        'type': 'string'},
        ...
        'description': {'description': 'Description of this mark for commenting purpose.',
        'type': 'string'},
        'name': {'description': 'Name of the visualization for later reference.',
        'type': 'string'},
        ...
        'params': {'description': 'Dynamic variables that parameterize a visualization.',
        'items': {'$ref': '#/definitions/Parameter'},
        'type': 'array'},
        'repeat': {'anyOf': [{'items': {'type': 'string'}, 'type': 'array'},
        ...
        'spec': {'anyOf': [{'$ref': '#/definitions/Spec'},
        ...
        'transform': {'description': 'An array of data transformations such as filter and new field calculation.',
        'items': {'$ref': '#/definitions/Transform'},
        'type': 'array'},
        'usermeta': {'$ref': '#/definitions/Dict<unknown>',
...
class RepeatChart(TopLevelMixin, core.TopLevelRepeatSpec):
    ...
    _schema = _repeat_chart_patched_schema
