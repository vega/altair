...
FUNCTION_LISTING = {
    ...
    "indexof": r"Returns the first index of _value_ in the input _array_.",
    ...
    "lastindexof": r"Returns the last index of _value_ in the input _array_.",
    "length": r"Returns the length of the input _array_.",
    ...
    "span": r"Returns the span of _array_: the difference between the last and first elements, or _array[array.length-1] - array[0]_.",
    # "indexof": r"Returns the first index of _substring_ in the input _string_.",
    # "lastindexof": r"Returns the last index of _substring_ in the input _string_.",
    # "length": r"Returns the length of the input _string_.",
    ...
    # "slice": r"Returns a section of _string_ between the _start_ and _end_ indices. If the _end_ argument is negative, it is treated as an offset from the end of the string (_length(string) + end_).",
